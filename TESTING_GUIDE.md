...
### 1. Protocol Package (@aigraphia/protocol)
...
### 2. Plugins Package (@aigraphia/plugins)
...
### 3. Layout Package (@aigraphia/layout)
...
### 5. Converters Package (@aigraphia/converters)
...
### 6. Export Package (@aigraphia/export)
...
### 7. Skills Package (@aigraphia/skills)
...
- [ ] Package scope is @aigraphia/* in all package.json files
- [ ] LICENSE file exists
