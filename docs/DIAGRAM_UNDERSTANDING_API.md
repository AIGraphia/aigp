...
```typescript
import { summarizeDiagram, analyzeComplexity, detectPatterns } from '@aigp/understanding';
...
```typescript
import { searchDiagram, answerQuestion } from '@aigp/understanding';
...
```typescript
import { generateDocumentation } from '@aigp/understanding';
