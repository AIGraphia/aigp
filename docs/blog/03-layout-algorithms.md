...
```typescript
import { hierarchicalLayout, forceLayout } from '@aigraphia/layout';
...
```typescript
import type { LayoutAlgorithm } from '@aigraphia/layout';
...
Register and use:
```typescript
import { registerLayout } from '@aigraphia/layout';
