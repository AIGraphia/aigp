...
pnpm init
pnpm install @aigp/protocol zod
...
```typescript
import type { Graph, LayoutResult, LayoutOptions } from '@aigp/protocol';
...
```typescript
import type { AIGPDocument, ValidationError } from '@aigp/protocol';
...
```typescript
import type { AIGPPlugin } from '@aigp/protocol';
