...
```bash
pnpm add @aigp/react react react-dom
# or
yarn add @aigp/react react react-dom
# or
pnpm add @aigp/react react react-dom
```
...
```tsx
import { DiagramViewer } from '@aigp/react';
...
```tsx
import { DiagramEditor } from '@aigp/react';
...
```tsx
import { DiagramList } from '@aigp/react';
...
```tsx
import { DiagramCard } from '@aigp/react';
...
```tsx
import { DiagramUpload } from '@aigp/react';
...
```tsx
import { DiagramExport } from '@aigp/react';
import { useState } from 'react';
...
```tsx
import { useDiagram } from '@aigp/react';
...
```tsx
import { useDiagramValidation } from '@aigp/react';
...
```tsx
import { useDiagramExport } from '@aigp/react';
...
```tsx
import '@aigp/react/dist/styles.css'; // Default styles
...
```typescript
import { DiagramViewer, DiagramEditor, useDiagram } from '@aigp/react';
import type { DiagramViewerProps, DiagramEditorProps } from '@aigp/react';
```
...
- NPM: https://www.npmjs.com/package/@aigp/react
