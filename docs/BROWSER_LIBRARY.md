...
```typescript
import AIGP, { AIGPDocument, RenderOptions, ValidationResult } from '@aigp/browser';
...
```html
<!-- Latest -->
<script src="https://cdn.jsdelivr.net/npm/@aigp/browser@latest/dist/aigp.min.js"></script>

<!-- Specific version -->
<script src="https://cdn.jsdelivr.net/npm/@aigp/browser@1.0.0/dist/aigp.min.js"></script>

<!-- Unpkg -->
<script src="https://unpkg.com/@aigp/browser@1.0.0/dist/aigp.min.js"></script>
```
...
- NPM: https://www.npmjs.com/package/@aigp/browser
