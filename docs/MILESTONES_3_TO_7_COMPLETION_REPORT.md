...
#### 1. SVG Exporter
- **Package**: `@aigraphia/export` (already existed)
- **Features**:
...
#### 2. PNG Exporter
- **Package**: `@aigraphia/export` with headless browser support
- **Features**:
...
- **Package**: `@aigraphia/converters` extension
- **Compatibility**:
  - yEd (full support)
...
- **Package**: `@aigraphia/schema-builder`
- **Features**:
