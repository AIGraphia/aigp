...
### Quick Start
```javascript
import { AIGPDocument, validate, render } from '@aigp/browser';
...
### Quick Start
```jsx
import { DiagramViewer, DiagramEditor } from '@aigp/react';
...
### REST API Client
```typescript
import { AIGPClient } from '@aigp/api-client';
...
```html
<!-- Usage -->
<script src="https://cdn.jsdelivr.net/npm/@aigp/schema-builder"></script>
...
```typescript
import { createTestDiagram, mockNode, mockEdge } from '@aigp/testing';
...
|---------|----------------|---------|
| @aigp/browser | 45 KB | 12 KB |
| @aigp/react | 52 KB | 14 KB |
| @aigp/vue | 48 KB | 13 KB |
| @aigp/api-client | 15 KB | 5 KB |
