...
```bash
pnpm install @aigp/vue vue
# or
yarn add @aigp/vue vue
# or
pnpm add @aigp/vue vue
```
...
import { DiagramViewer } from '@aigp/vue';
import { ref } from 'vue';
...
<script setup lang="ts">
import { DiagramEditor } from '@aigp/vue';
import { ref } from 'vue';
...
<script setup lang="ts">
import { DiagramList } from '@aigp/vue';
import { ref, onMounted } from 'vue';
import { useRouter } from 'vue-router';
import type { DiagramMetadata } from '@aigp/vue';
...
<script setup lang="ts">
import { DiagramCard } from '@aigp/vue';
import type { DiagramMetadata } from '@aigp/vue';
...
<script setup lang="ts">
import { DiagramUpload } from '@aigp/vue';
import type { AIGPDocument } from '@aigp/protocol';
...
<script setup lang="ts">
import { DiagramExport } from '@aigp/vue';
import { ref } from 'vue';
import type { AIGPDocument } from '@aigp/protocol';
...
<script setup lang="ts">
import { useDiagram } from '@aigp/vue';
...
<script setup lang="ts">
import { useDiagramValidation } from '@aigp/vue';
import { ref } from 'vue';
import type { AIGPDocument } from '@aigp/protocol';
...
<script setup lang="ts">
import { useDiagramExport } from '@aigp/vue';
import { ref } from 'vue';
...
import type { AIGPDocument, DiagramMetadata } from '@aigp/vue';
...
```typescript
import '@aigp/vue/dist/style.css';
```
...
```typescript
import { DiagramViewer, DiagramEditor, useDiagram } from '@aigp/vue';
import type { DiagramViewerProps, DiagramEditorProps } from '@aigp/vue';
```
...
- NPM: https://www.npmjs.com/package/@aigp/vue
